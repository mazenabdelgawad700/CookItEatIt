...
namespace RecipeApp.Infrastructure.Migrations
{
    ...
    [Migration("20250314141816_UpdateInstructionTable")]
    partial class UpdateInstructionTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RecipeApp.Domain.Entities.Models.Recipe", b =>
                {
                    ...
                    b.ToTable("Recipe", "dbo", t =>
                        {
                            t.HasTrigger("tr_Recipe_UpdateRecipesCount");
                        });
            ...
            modelBuilder.Entity("RecipeApp.Domain.Entities.Models.UserPreferredDishes", b =>
                {
                    ...
                    b.HasKey("UserId", "PreferredDishId");
            ...
            modelBuilder.Entity("RecipeApp.Domain.Entities.Models.UserPreferredCategory", b =>
                {
                    ...
                    b.HasOne("RecipeApp.Domain.Entities.Identity.ApplicationUser", "ApplicationUser")
                        .WithMany("UserPreferredCategories")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RecipeApp.Domain.Entities.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("UserPreferredDishes");
                });
